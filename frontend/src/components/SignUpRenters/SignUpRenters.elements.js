...
export const RentersSection = styled.div`
  background: #fff;
  padding: 100px 0 0 0;
  color: #000;
`;

export const RentersRow = styled.div`
  display: flex;
  flex-wrap: wrap;
  align-items: center;
...
export const RentersColumn = styled.div`
  margin-bottom: 10px;
  padding-right: 20px;
  padding-left: 20px;
  flex: 1;
...
export const RentersFormContainer = styled.div`
  display: flex;
  align-items: center;
  justify-content: center;
`;

export const RentersFormCard = styled.div`
  display: flex;
...
export const RentersHeading = styled.h1`
  margin-bottom: 5px;
  margin-right: 1rem;
  font-size: 28px;
  line-height: 1;
...
export const RentersSubHeading = styled.p`
  margin-bottom: 30px;
  margin-right: 1rem;
  margin-top: 3px;
  font-size: 13px;
